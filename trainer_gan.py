...
class Trainer():
    ...
    def train_step(self):
        ...
        for i, batch in tqdm(enumerate(self.train_loader), file=sys.stdout, total=len(self.train_loader)): #tqdm output will not be written to logger file(will only written to stdout)
